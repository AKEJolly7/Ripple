...
- **JDK 21+**（本仓库约定 `JAVA_HOME` 指向它；默认 java 是 8 的机器见常见问题）
- **Maven 3.9+**
...
```
MAVEN_SKIP_RC 跳过 ~/.mavenrc 的旧 JAVA_HOME（本机开发环境：`JAVA_HOME=~/tools/jdk-21.0.12.1+1/Contents/Home`）

**4. HN Algolia 偶发 429/500？**
...
- [MILESTONES.md](MILESTONES.md) —— R0-R8 里程碑与验收记录
